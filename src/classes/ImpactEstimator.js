...
class ImpactEstimator {
  ...
  dollarsInFlight() {
    ...
    const percentOfIncomePopulation = Math.trunc(this.avgDailyIncomePopulation * 100);
    const perInfectedReg = Math.trunc(this.infectionsByRequestedTime() * percentOfIncomePopulation);
